<div class="max-w-xl mx-auto">
    <form wire:submit.prevent="guardar" class="bg-white p-6 rounded shadow">
        <h2 class="text-lg font-bold mb-4">Crear Herramienta</h2>
        ...
        <div class="mb-4">
            ...
            <input type="text" wire:model.defer="username" class="w-full rounded border-gray-300 shadow-sm mt-1" />
            @error('username') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
        </div>

        <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700">Contraseña</label>
            <input type="text" wire:model.defer="password" class="w-full rounded border-gray-300 shadow-sm mt-1" />
